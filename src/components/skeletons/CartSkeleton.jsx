...
const CartSkeleton = () => {
  return (
    <div className="w-full flexCenter flex-col animate-pulse">
      ...
      <div className="w-full flexCenter flex-col gap-4 mt-36">
        {Array.from({ length: 3 }).map((_, index) => (
          ...
          >
            ...
            {/* Quantity Actions */}
            <div className="flexBetweenCenter gap-6 border-2 border-gray-300 py-1 px-3 rounded-full min-w-[130px]">
