...
const Homepage = () => {
  // const { products: books, loading: booksLoading } = useCategoryProducts({
  //   parentCategoryName: "Books",
  //   subCategoryName: "Fictional Books",
  // });
  ...
  return (
    <div className="flex flex-col gap-8 ">
      ...
      <div className="space-y-8 -mt-[18rem] relative z-10">
        {/* Services section */}
        <section className="relative z-20 flex flex-wrap w-[90%] mx-auto justify-between gap-4">
          {[
            {
              icon: (
        ...
        <div>
          {/* <SwiperSlider
            ...
            data={books}
            getId={(book) => book._id}
            getImage={(book) => book.images?.[0]?.url}
